...
INITIAL_LOCATIONS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "texts": {
            ...
            "easter_egg": "Столб для лазания специально смазывают бараньим салом или мылом, чтобы сделать его почти неприступным, высота 10-15 метров. Традиционным призом наверху был живой петух в клетке или узорные сапоги-ичиги.",
        },
        "artifact": {
            "id": "polotentse",
            "name": "Полотенце",
    ...
    },
    {
        ...
        "texts": {
            ...
            "easter_egg": "Есть легенда о происхождении чак-чака: хан Булгарии хотел выдать дочь замуж за того, кто принесет самый большой выкуп золотом. Небогатый юноша, влюбленный в нее, попросил помощи у матери, она собрала последние деньги на муку и мед и приготовила угощение, издалека похожее на гору золота.",
        },
        "artifact": {
            "id": "chak_chak",
            "name": "Чак-чак",
